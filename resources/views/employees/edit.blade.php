...
<div class="card">
    <div class="card-header">
        <h5 class="mb-0">Modifier un Employé</h5>
    </div>
    <div class="card-body">
        @if ($errors->any())
        ...
        <form action="{{ route('employees.update', $employee) }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" class="form-control @error('standard_hours_per_day') is-invalid @enderror" name="standard_hours_per_day" value="{{ old('standard_hours_per_day', $employee->standard_hours_per_day) }}" min="1" max="24" required>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" step="0.1" class="form-control @error('overtime_threshold_hours') is-invalid @enderror" name="overtime_threshold_hours" value="{{ old('overtime_threshold_hours', $employee->overtime_threshold_hours) }}" min="0" max="100">
                ...
                <div class="col-md-12 mb-3">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="is_active" id="is_active" {{ old('is_active', $employee->is_active) ? 'checked' : '' }}>
